...
read -p "What's your development team id? (You can leave this blank or find it here https://developer.apple.com/account under 'Membership details') " DEVELOPMENT_TEAM_INPUT
